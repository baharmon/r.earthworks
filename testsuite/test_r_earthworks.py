...
class TestREarthworks(TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.runModule(
            "g.region",
            n=10, s=0, e=10, w=0, res=1
            )
        cls.runModule(
            "r.mapcalc",
            expression=f"{cls.input} = 0"
            )
    ...
    def tearDown(cls):
        ...
        cls.runModule(
            ...
            flags="f",
            type="raster",
            name=[cls.fill, cls.cut, cls.cutfill]
            )
    ...
    def test_fill_operation(self):
        ...
        self.assertRasterMinMax(
            ...
            refmin=0,
            refmax=1,
            msg="Elevation must be between 0 and 1."
            )
    ...
    def test_cut_operation(self):
        ...
        self.assertRasterMinMax(
            ...
            refmin=-1,
            refmax=0,
            msg="Elevation must be between -1 and 0."
            )
        self.assertRasterExists(
            name=self.cut,
            msg="Output was not created"
